    ...
    <div style={{ maxWidth: '700px' }}>
      ...
      <div style={{ background: '#0F0F1A', border: '1px solid rgba(0,229,255,0.08)', padding: '32px', position: 'relative' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <textarea
            style={{ width: '100%', background: '#111320', border: '1px solid rgba(0,229,255,0.15)', padding: '14px 16px', color: '#E8E4DC', fontFamily: 'Inter,sans-serif', fontSize: '13px', outline: 'none', minHeight: '160px', resize: 'vertical' }}
        ...
        <button onClick={handleSend} disabled={sending} style={{ background: '#00E5FF', border: 'none', color: '#0A0A0F', padding: '14px 32px', fontSize: '11px', fontWeight: '700', letterSpacing: '2px', textTransform: 'uppercase', cursor: 'pointer', fontFamily: 'Inter,sans-serif', clipPath: 'polygon(6px 0%,100% 0%,calc(100% - 6px) 100%,0% 100%)', opacity: sending ? 0.6 : 1 }}>
