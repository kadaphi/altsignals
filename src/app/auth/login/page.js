    ...
    <div style={{ minHeight:'100vh', background:'#0A0A0F', display:'flex', alignItems:'center', justifyContent:'center', padding:'20px', fontFamily:"'Inter',sans-serif" }}>
      ...
      <div style={{ width:'100%', maxWidth:'440px' }}>
        <div style={{ textAlign:'center', marginBottom:'40px' }}>
          ...
          <div style={{ fontSize:'13px', color:'#8A8E99' }}>Sign in to your account</div>
        </div>
        <div style={{ background:'#111320', border:'1px solid rgba(0,229,255,0.12)', padding:'40px', position:'relative' }}>
          ...
          <div style={{ marginBottom:'12px' }}>
            ...
            <input className="auth-input" type="password" placeholder="Your password" value={form.password} onChange={e => setForm({...form, password: e.target.value})} onKeyDown={e => e.key === 'Enter' && handleSubmit()} />
          </div>
